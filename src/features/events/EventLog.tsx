 ...
 *
 * Renders inline within MetaPanel. Shows a scrolling list with filtering
 * by event type (broadcasts, lifecycle, messages).
 */
...
export function EventLog() {
  ...
  const filteredEvents = events.filter((e) => {
    ...
    return showLifecycle; // spawn, statusChange, removal
  });
    ...
    <div className="event-log">
      <div className="event-log__filters">
        <label className="event-log__filter">
          ...
          />
          <span style={{ color: palette.sapphire }}>Bcast</span>
        </label>
        <label className="event-log__filter">
          <input
            type="checkbox"
          ...
          />
          <span style={{ color: palette.green }}>Life</span>
        </label>
        <label className="event-log__filter">
          <input
            type="checkbox"
          ...
          />
          <span style={{ color: palette.mauve }}>Msgs</span>
        </label>
        <button className="event-log__clear" onClick={clear}>
          Clear
        </button>
      </div>
      <div className="event-log__list" ref={logRef}>
